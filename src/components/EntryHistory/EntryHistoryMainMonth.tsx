...
export class EntryHistoryMainMonth extends React.Component<Props> {
  data: Props;
  ...
  render() {
    ...
    return (
      <form className="entry-history entry-history_main month" name={`entry${idItem}`} id={`${idItem}`}>
...
export default EntryHistoryMainMonth;
